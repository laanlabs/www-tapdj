...
body {
	background: #e3e6e8 url('/_lib/images/tiny-bk.jpg') repeat-x left top;
}
...
<div id="mixes">
	...
	<div id="mix" >
		...
		<div id="mixCredits">
			...
			<div id="collectionName"><?=preview_text($r['collection_name'],28) ?></div>
	
		</div>
		</div>
			<div id="itunesLink">
				<a href="<?=TAPDJMix::makeAffiliateLink($r['ext_itunes_track_url'], $country_code)?>"  onClick="_gaq.push(['_trackEvent', 'Downloads', 'app', 'get app']);  target_="new"><img src="http://ax.phobos.apple.com.edgesuite.net/images/web/linkmaker/badge_itunes-lrg.gif" border="0"/></a>
			</div>
